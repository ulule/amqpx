...
func (ch channelWrapper) NotifyConfirm(ack, nack chan uint64) (chan uint64, chan uint64) {
...
func (ch channelWrapper) QueueDeclare(name string, durable, autoDelete, exclusive, noWait bool, args Table) (Queue, error) {
	return ch.channel.QueueDeclare(name, durable, autoDelete, exclusive, noWait, args)
}

func (ch channelWrapper) QueueDeclarePassive(name string, durable, autoDelete, exclusive, noWait bool, args Table) (Queue, error) {
...
func (ch channelWrapper) QueueBind(name, key, exchange string, noWait bool, args Table) error {
	return ch.channel.QueueBind(name, key, exchange, noWait, args)
}

func (ch channelWrapper) QueueUnbind(name, key, exchange string, args Table) error {
...
func (ch channelWrapper) QueueDelete(name string, ifUnused, ifEmpty, noWait bool) (int, error) {
	return ch.channel.QueueDelete(name, ifUnused, ifEmpty, noWait)
}

func (ch channelWrapper) Consume(queue, consumer string, autoAck, exclusive, noLocal, noWait bool, args Table) (<-chan Delivery, error) {
	return ch.channel.Consume(queue, consumer, autoAck, exclusive, noLocal, noWait, args)
}

func (ch channelWrapper) ExchangeDeclare(name, kind string, durable, autoDelete, internal, noWait bool, args Table) error {
	return ch.channel.ExchangeDeclare(name, kind, durable, autoDelete, internal, noWait, args)
}

func (ch channelWrapper) ExchangeDeclarePassive(name, kind string, durable, autoDelete, internal, noWait bool, args Table) error {
...
func (ch channelWrapper) ExchangeBind(destination, key, source string, noWait bool, args Table) error {
	return ch.channel.ExchangeUnbind(destination, key, source, noWait, args)
}

func (ch channelWrapper) ExchangeUnbind(destination, key, source string, noWait bool, args Table) error {
	return ch.channel.ExchangeUnbind(destination, key, source, noWait, args)
}
